																				...
																				<tr>
																					...
																					<div align="center">
																						<table style="width: 166px; height: 100%" cellpadding="0">
																							<tr>
																								<td style="width: 55px"><a href="index.php?do=giftitem&itemid=<?=$set[1][$cpage]['SSID']?>&cat=<?=$cat?>"><img border="0" id="76286ns7b2" src="images/btn_giftitem_off.jpg" width="50" height="23" onMouseOut="FP_swapImgRestore()" onMouseOver="FP_swapImg(1,1,/*id*/'76286ns7b2',/*url*/'images/btn_giftitem_on.jpg')"></a></td>
																								<td style="width: 55px"> <a href="index.php?do=buyitem&itemid=<?=$set[1][$cpage]['SSID']?>&cat=<?=$cat?>"> <img border="0" id="76286ns7b4" src="images/btn_buyitem3_off.jpg" width="52" height="23" onMouseOut="FP_swapImgRestore()" onMouseOver="FP_swapImg(1,1,/*id*/'76286ns7b4',/*url*/'images/btn_buyitem3_on.jpg')"></a></td>
																			...
																			<table border="0" style="border-collapse: collapse" width="170">
																				...
																				<tr>
																					...
																					<div align="center">
																						<table style="width: 166px; height: 100%" cellpadding="0">
																							<tr>
																								<td style="width: 55px"><a href="index.php?do=giftitem&itemid=<?=$set[2][$cpage]['SSID']?>&cat=<?=$cat?>"><img border="0" id="76286ns7b27" src="images/btn_giftitem_off.jpg" width="50" height="23" onMouseOut="FP_swapImgRestore()" onMouseOver="FP_swapImg(1,1,/*id*/'76286ns7b27',/*url*/'images/btn_giftitem_on.jpg')"></a></td>
																								<td style="width: 55px"> <a href="index.php?do=buyitem&itemid=<?=$set[2][$cpage]['SSID']?>&cat=<?=$cat?>"> <img border="0" id="76286ns7b47" src="images/btn_buyitem3_off.jpg" width="52" height="23" onMouseOut="FP_swapImgRestore()" onMouseOver="FP_swapImg(1,1,/*id*/'76286ns7b47',/*url*/'images/btn_buyitem3_on.jpg')"></a></td>
																			...
																			<table border="0" style="border-collapse: collapse" width="170">
																				...
																				<tr>
																					...
																					<div align="center">
																						<table style="width: 166px; height: 100%" cellpadding="0">
																							<tr>
																								<td style="width: 55px"><a href="index.php?do=giftitem&itemid=<?=$set[3][$cpage]['SSID']?>&cat=<?=$cat?>"><img border="0" id="76286ns7b21" src="images/btn_giftitem_off.jpg" width="50" height="23" onMouseOut="FP_swapImgRestore()" onMouseOver="FP_swapImg(1,1,/*id*/'76286ns7b21',/*url*/'images/btn_giftitem_on.jpg')"></a></td>
																								<td style="width: 55px"> <a href="index.php?do=buyitem&itemid=<?=$set[3][$cpage]['SSID']?>&cat=<?=$cat?>"> <img border="0" id="76286ns7b41" src="images/btn_buyitem3_off.jpg" width="52" height="23" onMouseOut="FP_swapImgRestore()" onMouseOver="FP_swapImg(1,1,/*id*/'76286ns7b41',/*url*/'images/btn_buyitem3_on.jpg')"></a></td>
																			...
																			<table border="0" style="border-collapse: collapse" width="170">
																				...
																				<tr>
																					...
																					<div align="center">
																						<table style="width: 166px; height: 100%" cellpadding="0">
																							<tr>
																								<td style="width: 55px"><a href="index.php?do=giftitem&itemid=<?=$set[4][$cpage]['SSID']?>&cat=<?=$cat?>"><img border="0" id="76286ns7b26" src="images/btn_giftitem_off.jpg" width="50" height="23" onMouseOut="FP_swapImgRestore()" onMouseOver="FP_swapImg(1,1,/*id*/'76286ns7b26',/*url*/'images/btn_giftitem_on.jpg')"></a></td>
																								<td style="width: 55px"> <a href="index.php?do=buyitem&itemid=<?=$set[4][$cpage]['SSID']?>&cat=<?=$cat?>"> <img border="0" id="76286ns7b46" src="images/btn_buyitem3_off.jpg" width="52" height="23" onMouseOut="FP_swapImgRestore()" onMouseOver="FP_swapImg(1,1,/*id*/'76286ns7b46',/*url*/'images/btn_buyitem3_on.jpg')"></a></td>
																			...
																			<table border="0" style="border-collapse: collapse" width="170">
																				...
																				<tr>
																					...
																					<div align="center">
																						<table style="width: 166px; height: 100%" cellpadding="0">
																							<tr>
																								<td style="width: 55px"><a href="index.php?do=giftitem&itemid=<?=$set[5][$cpage]['SSID']?>&cat=<?=$cat?>&cat=<?=$cat?>"><img border="0" id="76286ns7b211" src="images/btn_giftitem_off.jpg" width="50" height="23" onMouseOut="FP_swapImgRestore()" onMouseOver="FP_swapImg(1,1,/*id*/'76286ns7b211',/*url*/'images/btn_giftitem_on.jpg')"></a></td>
																								<td style="width: 55px"> <a href="index.php?do=buyitem&itemid=<?=$set[5][$cpage]['SSID']?>&cat=<?=$cat?>&cat=<?=$cat?>"> <img border="0" id="76286ns7b411" src="images/btn_buyitem3_off.jpg" width="52" height="23" onMouseOut="FP_swapImgRestore()" onMouseOver="FP_swapImg(1,1,/*id*/'76286ns7b411',/*url*/'images/btn_buyitem3_on.jpg')"></a></td>
																			...
																			<table border="0" style="border-collapse: collapse" width="170">
																				...
																				<tr>
																					...
																					<div align="center">
																						<table style="width: 166px; height: 100%" cellpadding="0">
																							<tr>
																								<td style="width: 55px"><a href="index.php?do=giftitem&itemid=<?=$set[6][$cpage]['SSID']?>&cat=<?=$cat?>&cat=<?=$cat?>"><img border="0" id="76286ns7b233" src="images/btn_giftitem_off.jpg" width="50" height="23" onMouseOut="FP_swapImgRestore()" onMouseOver="FP_swapImg(1,1,/*id*/'76286ns7b233',/*url*/'images/btn_giftitem_on.jpg')"></a></td>
																								<td style="width: 55px"> <a href="index.php?do=buyitem&itemid=<?=$set[6][$cpage]['SSID']?>&cat=<?=$cat?>&cat=<?=$cat?>"> <img border="0" id="76286ns7b433" src="images/btn_buyitem3_off.jpg" width="52" height="23" onMouseOut="FP_swapImgRestore()" onMouseOver="FP_swapImg(1,1,/*id*/'76286ns7b433',/*url*/'images/btn_buyitem3_on.jpg')"></a></td>
