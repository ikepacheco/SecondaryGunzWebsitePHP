<?php
SetTitle("SecondaryGunz - TeamSpeak");
?>
						...
						<div align="center">
							<table border="1" style="border-collapse: collapse" width="100%" bordercolor="#000000">
								<tr>
									...
									<div align="center">
										<b><font face="Tahoma" size="2">Servidor de TeamSpeak</font></b></td>
							  </tr>
								<tr>
									<td bgcolor="#2C2A2A">
									<div align="center"><form method="POST" action="index.php?do=changebt" name="changebt">
									  <table width="500" border="0">
                                        <tr>
                                          <td><div align="center">TeamSpeak 3</div></td>
                                        </tr>
                                        <tr>
                                          <td><table width="500" border="0">
                                            <tr>
                                              <td>Address:</td>
                                              <td><div align="center">secondaryts3.ath.cx</div></td>
                                            </tr>
                                            <tr>
                                              <td>Puerto:</td>
                                              <td><div align="center">9987</div></td>
                                            </tr>
                                            <tr>
                                              <td>Descargar:</td>
                                              <td><div align="center"><a href="http://www.teamspeak.com/?page=downloads">Click Aqui</a></div></td>
                                            </tr>
                                          </table></td>
                                        </tr>
                                      </table>
